...
export class StockController {
  ...
  @ApiQuery({
    ...
    required: false,
    type: Boolean,
    description: 'Filtrar por produtos com estoque baixo',
  })
  @ApiQuery({
    name: 'expiringSoon',
    required: false,
    type: Boolean,
    description: 'Filtrar por produtos vencendo em breve',
  })
  @ApiQuery({
    name: 'requiresPrescription',
    required: false,
    type: Boolean,
    description: 'Filtrar por produtos que requerem prescrição',
  })
  @ApiQuery({
    name: 'minPrice',
    required: false,
    type: Number,
    description: 'Valor mínimo de preço',
  })
  @ApiQuery({
    name: 'maxPrice',
    required: false,
    type: Number,
    description: 'Valor máximo de preço',
  })
  @ApiQuery({
    name: 'sortBy',
    required: false,
  ...
  @UseGuards(RolePermissionGuard)
  resolveAlert(@Param('id') id: string, @Body() body: { notes?: string }) {
