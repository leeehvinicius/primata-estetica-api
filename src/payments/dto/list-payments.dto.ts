...
export class ListPaymentsDto {
    ...
    @ApiProperty({ description: 'Filtrar por método de pagamento', enum: PaymentMethod, required: false })
    @IsOptional()
    @IsEnum(PaymentMethod)
    paymentMethod?: PaymentMethod;

    @ApiProperty({ description: 'Filtrar por status', enum: PaymentStatus, required: false })
    @IsOptional()
    ...
    @ApiProperty({ description: 'Ordenar por campo', required: false, default: 'paymentDate' })
    @IsOptional()
    @IsString()
