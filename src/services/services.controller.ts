...
export class ServicesController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Lista de serviços por faixa de preço',
  })
  ...
  getServicesByPriceRange(
    ...
    return this.services.getServicesByPriceRange(
      Number(minPrice),
      Number(maxPrice),
    );
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Lista de serviços por duração máxima',
  })
  ...
  // ⚠ FICA ANTES DE @Get(':id') PARA NÃO CONFLITAR
