...
export class ExternalIntegrationController {
  ...
  async syncWithAccountingSystem(
    @Body() syncData: { startDate: Date; endDate: Date },
  ) {
  ...
  async syncClientsWithCrm(@Body() syncData: { clientIds?: string[] }) {
    return this.externalIntegrationService.syncClientsWithCrm(
      syncData.clientIds,
    );
  }
  ...
  async importFromCrm(
    @Body() importData: { lastSync?: Date; status?: string; tags?: string[] },
  ) {
  ...
  async processIncomingWebhook(
    ...
    return this.externalIntegrationService.processIncomingWebhook(
      webhookData,
      signature,
    );
  }
  ...
  async sendCustomWebhook(
    @Body() webhookData: { type: string; data: any; event: string },
  ) {
  ...
  async getApiUsageStats(
    ...
    return this.externalIntegrationService.getApiUsageStats(
      integrationId,
      period,
    );
  }
