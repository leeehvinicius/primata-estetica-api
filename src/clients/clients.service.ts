...
export class ClientsService {
  ...
  async create(dto: CreateClientDto) {
    ...
    if (dto.emergencyContact)
      clientData.emergencyContact = dto.emergencyContact;
    ...
    if (dto.termsAccepted !== undefined)
      clientData.termsAccepted = dto.termsAccepted;
    if (dto.termsAcceptedAt)
      clientData.termsAcceptedAt = new Date(dto.termsAcceptedAt);
  ...
  async update(id: string, dto: UpdateClientDto) {
    ...
    if (dto.termsAccepted !== undefined)
      updateData.termsAccepted = dto.termsAccepted;
    if (dto.termsAcceptedAt !== undefined)
      updateData.termsAcceptedAt = dto.termsAcceptedAt
  ...
  async getStats() {
    ...
    const [total, active, inactive, byGender, newThisMonth, newThisYear] =
      await Promise.all([
