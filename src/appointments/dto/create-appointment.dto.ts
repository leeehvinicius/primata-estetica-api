import { IsString, IsOptional, IsEnum, IsDateString, IsNumber, Min, IsArray, IsUUID } from 'class-validator';
...
export class CreateAppointmentDto {
    ...
    @ApiProperty({ description: 'Prioridade do agendamento', enum: AppointmentPriority, required: false, default: 'NORMAL' })
    @IsOptional()
    ...
    @ApiProperty({ description: 'Canais de notificação', required: false, type: [String] })
    @IsOptional()
    @IsArray()
    @IsString({ each: true })
