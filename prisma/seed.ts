...
<<<<<<< HEAD
  ...
  const defaultServiceCategories = [
    {
      ...
      description: 'Categoria para serviços faciais',
    },
    {
      name: 'Tratamentos Corporais',
      description: 'Categoria para serviços corporais',
    },
    { name: 'Depilação', description: 'Categoria para serviços de depilação' },
    {
      name: 'Limpeza de Pele',
      description: 'Categoria para serviços de limpeza de pele',
    },
    {
      name: 'Procedimentos Estéticos',
      description: 'Categoria para procedimentos estéticos',
    },
    { name: 'Consultas', description: 'Categoria para consultas' },
    {
      name: 'Manutenção',
      description: 'Categoria para serviços de manutenção',
    },
  ...
  let admin = await prisma.user.findFirst({
    where: { profile: { role: Role.ADMINISTRADOR } },
  });
  if (!admin) {
